...
const Footer = () => {
  const footerLinks = {
    curso: [
      { label: "Sobre o Curso", href: "#curso" },
          ...
          <div className="grid lg:grid-cols-5 gap-8">
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <p className="text-muted-foreground leading-relaxed max-w-md">
                Transformamos profissionais em especialistas de dados através de metodologia prática, 
                projetos reais e mentoria personalizada. Sua jornada para uma carreira de sucesso começa aqui.
              </p>
