      ...
      <div className="container mx-auto px-4 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Curriculum desenhado por profissionais da indústria com foco em resultados práticos e empregabilidade.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          {features.map((feature, index) => (
            <div
              key={index}
              className="group relative bg-card p-8 rounded-2xl shadow-card hover:shadow-hero transition-smooth border border-border hover:border-primary/20"
            >
        ...
        <div className="text-center bg-gradient-bg p-12 rounded-3xl border border-border">
          ...
          <p className="text-muted-foreground mb-8 max-w-md mx-auto">
            Junte-se a centenas de profissionais que já transformaram suas carreiras com nosso método.
          </p>
