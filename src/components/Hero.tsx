                ...
                <section>
                    <div className="relative pt-24 md:pt-36">
                        <AnimatedGroup
                            ...
                            <div className="w-full h-full absolute inset-0 bg-gradient-bg" />
                        </AnimatedGroup>
                            ...
                            <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                                <AnimatedGroup variants={transitionVariants}>
                                    ...
                                    <p
                                        ...
                                        Transforme sua carreira com o curso mais completo do mercado. Aprenda desde fundamentos até projetos avançados com dados reais, ferramentas modernas e metodologias da indústria.
                                    </p>
                                </AnimatedGroup>
                            ...
                            <div className="relative -mr-56 mt-8 overflow-hidden px-2 sm:mr-0 sm:mt-12 md:mt-20">
                                ...
                                <div className="inset-shadow-2xs ring-background dark:inset-shadow-white/20 bg-background relative mx-auto max-w-6xl overflow-hidden rounded-2xl border p-4 shadow-lg shadow-zinc-950/15 ring-1">
                                    <img
                                        ...
                                        src={heroImage}
                                        alt="Engenharia e Análise de Dados - Dashboard com gráficos e métricas"
                                        width="2700"
                                        height="1440"
                                    />
                                </div>
                    ...
                    <div className="group relative m-auto max-w-5xl px-6">
                        <div className="absolute inset-0 z-10 flex scale-95 items-center justify-center opacity-0 duration-500 group-hover:scale-100 group-hover:opacity-100">
                            <div className="block text-sm duration-150 hover:opacity-75">
                                <span>Empresas que Confiam em Nossos Profissionais</span>
                        ...
                        <div className="group-hover:blur-xs mx-auto mt-12 grid max-w-2xl grid-cols-4 gap-x-12 gap-y-8 transition-all duration-500 group-hover:opacity-50 sm:gap-x-16 sm:gap-y-14">
                            ...
                            <div className="flex">
                                <img
                                    className="mx-auto h-5 w-fit dark:invert"
                                    src="https://html.tailus.io/blocks/customers/spotify.svg"
                                    alt="Spotify Logo"
                                    height="20"
                                    width="auto"
                                />
                            ...
                            <div className="flex">
                                <img
                                    className="mx-auto h-4 w-fit dark:invert"
                                    src="https://html.tailus.io/blocks/customers/uber.svg"
                                    alt="Uber Logo"
                                    height="16"
                                    width="auto"
                                />
                            ...
                            <div className="flex">
                                <img
                                    ...
                                    src="https://html.tailus.io/blocks/customers/tesla.svg"
                                    alt="Tesla Logo"
                                    height="24"
                                    width="auto"
                                />
